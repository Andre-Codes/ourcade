...
The image should be a neatly arranged step-by-step drawing guide in the style of a vintage beginner art plate. Use a warm off-white paper background, crisp black line art, and a simple nostalgic instructional-book look. The final result should feel like an old-fashioned children’s drawing manual: charming, clear, tidy, and easy to follow.
...
* Vintage beginner drawing-book aesthetic

* Clean black ink outlines

* Minimal shading or no shading

* Warm cream or off-white paper background

* Slightly nostalgic print-manual look

* Simple, beginner-friendly forms

* Consistent line weight

* Cute, playful, approachable subject design

* No full color rendering

* No extra decorative sidebars, tips, or poster-style bonus content
...
* Use 8 steps total unless the subject clearly needs 9 or 10

* Arrange the steps in a clean grid

* Put each step inside its own clearly separated rectangular panel

* Keep spacing even and the layout highly organized

* Make every step easy to crop individually

* Include a small step number in each panel

* Include a short caption under each drawing inside the panel

* Captions should be brief and direct, such as:
...
* The captions should be short, readable, and consistent in tone
...
1. Start with the main base shape.

2. Add the secondary large form.

3. Add connecting structure or silhouette.

4. Add defining features.

5. Add limbs, wings, accessories, or major details.

6. Refine the subject so it is clearly recognizable.

7. Add remaining details such as tail, expression, texture, or small props.

8. Show the finished simple line drawing.
...
* The subject must remain visually consistent from step to step

* Each step should clearly build on the previous one

* Keep the drawing simple enough for a beginner to copy

* Avoid overly complex anatomy or perspective

* Avoid clutter and unnecessary background details

* Avoid long instructional text

* Avoid decorative extras like tips, remix ideas, materials, or side notes

* Use only short step captions and step numbers as text

* Make the finished plate feel clean, calm, and practical
...
Write captions as very short action phrases, usually 2 to 10 words. 
